...
void smacoUnweightedGradient(const int n, const int p, const double *delta, const double *dold,
...
void smacofUnweightedHessian(const int p, const int p, const double *delta,
